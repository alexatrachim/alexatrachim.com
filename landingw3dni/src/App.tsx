...
import realizacja1 from './realizacja1.jpeg';
import realizacja2 from './realizacja2.jpeg';
import realizacja3 from './realizacja3.PNG';
import realizacja4 from './realizacja4.jpeg';
import realizacja5 from './realizacja5.jpeg';
      ...
      <section className="border-b-4 border-[#16121C] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { id: 0, title: "Self-Guidance Space", bg: "bg-[#B79FD4]", textColor: "text-[#16121C]", imageBorder: "border-[#16121C]", image: realizacja1 },
              { id: 1, title: "365 dni z EFT", bg: "bg-[#D590B2]", textColor: "text-[#16121C]", imageBorder: "border-[#16121C]", image: realizacja2 },
              { id: 2, title: "Wystartuj z tym biznesem EFT", bg: "bg-[#B79FD4]", textColor: "text-[#16121C]", imageBorder: "border-[#16121C]", image: realizacja3 },
              { id: 3, title: "Wiktoria Fahner", bg: "bg-[#D590B2]", textColor: "text-[#16121C]", imageBorder: "border-[#16121C]", image: realizacja4 },
              { id: 4, title: "Alexa Trachim", bg: "bg-[#B79FD4]", textColor: "text-[#16121C]", imageBorder: "border-[#16121C]", image: realizacja5 },
